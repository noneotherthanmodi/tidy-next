        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          ...
          <div className="px-5 sm:px-6 py-8">
            <div className="w-full max-w-md mx-auto">
              ...
              <h1 className="h2 font-playfair-display text-slate-800 mb-12">Sign in to Rizz</h1>
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6">
            <div className="w-full max-w-lg mx-auto">
              <h2 className="h3 md:text-4xl font-playfair-display text-slate-100 mb-4">The Rizz Inc.</h2>
              <div className="space-y-3">
              ...
              <div className="flex items-center mt-4">
                ...
                <div className="font-medium">
                  ...
                  <span className="text-slate-500">CEO, The Rizz Inc.</span>
                </div>
              </div>
            </div>
          </div>
